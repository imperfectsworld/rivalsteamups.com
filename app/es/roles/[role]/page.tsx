...
export default async function Page({ params }: { params: Promise<{ role: string }> }) { const { role } = await params; const name = roleMap[role]; if (!name) notFound(); return <Home roleFilter={name} locale="es" />; }
